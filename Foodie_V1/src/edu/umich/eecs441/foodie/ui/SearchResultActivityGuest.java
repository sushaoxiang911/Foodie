...
public class SearchResultActivityGuest extends Activity  implements ContentSettable{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_search_result_g);
		...
		PictureScanning ps = new PictureScanning (getApplicationContext().getFilesDir().getPath(),
					SearchResultActivityGuest.this);
		ps.execute(bitmap);
		// -----
	...
	public void startProgressDialog() {
		dialog = ProgressDialog.show(SearchResultActivityGuest.this, "Waiting...", "Obtaining Image");
	}
