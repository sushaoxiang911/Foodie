...
//			return null;
	...
	protected void onPostExecute(Bitmap result) {
		...
		rt = new ReceiveTranslation (contentSettableActivity);
		rt.execute(recMealName);
	...
	public String getMealTranslation() {
		mealTranslation = rt.getTranslationResult();
		if (mealTranslation.equals("")) {
			Log.i(TAG + "getMealTranslation", "result is empty. Haven't obtained or not existed");
		}
